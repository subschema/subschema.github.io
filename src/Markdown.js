...
} from 'rsg-components/Markdown/Table';
import InlinePlayground from './InlinePlayground';

// We’re explicitly specifying Webpack loaders here so we could skip specifying
// them in Webpack configuration.
// That way we could avoid clashes between our loaders and user loaders.
// eslint-disable-next-line import/no-unresolved
require(
    '!!react-styleguidist/loaders/style-loader!react-styleguidist/loaders/css-loader!highlight.js/styles/tomorrow.css');
...
const fix = (obj) => Object.keys(obj).reduce(function (ret, key) {
    if (ret[key].component && ret[key].component.default) {
        ret[key].component = ret[key].component.default;
    }
